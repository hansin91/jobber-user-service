...
import { CustomError, IAuthPayload, IErrorResponse, winstonLogger } from '@hansin91/jobber-shared';
...
import { consumeBuyerDirectMessage, consumeReviewFanoutMessages, consumeSeedGigDirectMessages, consumeSellerDirectMessage } from '@users/queues/consumer';
...
const usersErrorHandler = (app: Application): void => {
  app.use((error: IErrorResponse, _req: Request, res: Response, next: NextFunction) => {
    log.log('error', `UsersService ${error.service}:`, error);
